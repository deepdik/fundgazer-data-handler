...
from api.service.binance_service import (
    get_binance_ticker_price_service,
    get_binance_candle_stick_service,
    save_binance_candle_stick_service,
)
from api.service.fyers_service import (
    get_fyers_ticker_price_service,
    get_fyers_candle_stick_service,
...
async def get_symbol_kline(symbols: str, interval: str, exchange: Platforms):
    if exchange == Platforms.BINANCE:
        params = GetBinanceKlineParamsValidator(symbols=symbols, interval=interval)
        ...
        params = GetStockParamsValidator(symbols=symbols, interval=interval)
        params = {"symbols": params.symbols, "interval": params.interval}
