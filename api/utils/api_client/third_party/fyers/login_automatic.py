...
from api.repository.fyers_repo import save_fyers_access_token, get_fyers_access_token
...
async def get_fyers_obj():
    ...
    print(access_token)
    # save token to DB
    await save_fyers_access_token({"token": access_token,
                                   "valid_upto": get_current_local_time() + datetime.timedelta(hours=10)})
